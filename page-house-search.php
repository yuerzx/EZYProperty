							...
							<form method="get" action="">
								...
								<div class="tab_content">
									...
									<label for="project_name">项目名称</label>
										<select name="args[project_name]" id="project_name">
										<option value="">任意</option>
										<?php $house_projects = $wp_house->get_house_project();
										foreach($house_projects as $house_project) { ?>
											<option <?php if($house_project['project_name']==$_GET['args']['project_name']){echo 'selected="selected"';}?>><?php echo $house_project['project_name'];?></option>
										<?php } ?>
										</select>
									</p>
										<p class="clearfix">
										...
										<p class="clearfix">
											...
											<select name="args[bedroom]">
												<?php for($i=1;$i<=5;$i++){?>
													<option value="<?php echo $i;?>" <?php if($_GET['bedroom']==$i){echo 'selected="selected"';}?>><?php echo $i;?></option>
											<?php }?>
											</select>
										</p>
										<!--房间数-->
